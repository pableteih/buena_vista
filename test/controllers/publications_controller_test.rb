...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference("Publication.count") do
      post publications_url, params: { publication: { departament_id: @publication.departament_id, description: @publication.description } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { departament_id: @publication.departament_id, description: @publication.description } }
